...
//		public string _pays = "0,0,0,0,0";

//		[Tooltip("Represents how a symbol rewards a player. Normal will pay a player normally and FreeSpin will give a player free spins both according to the numbers specified in pays parameter. Custom does nothing and it is there so you can use your own code.")]
//		public PayType payType;
//		public MatchType matchType;
//		[Header("Generator Setting"), Range(0, 100), Tooltip("The parameter is used by SymbolGen and represents how often the symbol is randomly chosen to appears on a reel. The value is seen as relative weight in all the other symbols.  ")]
//		public float frequency = 50;

//		[Tooltip("The parameter is also used by Symbol gen and represents a minimum number of symbols guaranteed to appear on a reel. ")]
//		public int minCountPerReel = 0;

//		[HideInInspector]
//		public int[] pays;
//		[HideInInspector]
//		public int minChains = 0;
//		[NonSerialized]
//		internal SymbolLog log;
...
//			if (this.matchType == MatchType.Scatter || symbol.matchType == MatchType.Scatter) return false;
