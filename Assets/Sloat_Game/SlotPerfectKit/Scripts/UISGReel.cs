...
namespace BE {
	...
	public class UISGReel : MonoBehaviour {
        ...
        public void Spin()
        {
            ...
            {
                Symbols[i].transform.GetChild(1).gameObject.SetActive(false);
            }
            ...
            print("00 0 0 0 0 0 0 ======= > > >> >> >" + Hold_image.transform.GetChild(0).gameObject.activeSelf);
            if (!Hold_image.transform.GetChild(1).gameObject.activeSelf)
            {
                print("gam- - - - - >>>" + gameObject.name);
                InSpin = true;
                if (SlotGame.instance.hold)
                {
                    InStop = true;
                }
